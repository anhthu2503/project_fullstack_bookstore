...
// //cai dat socket io tu client len server
...
// //Server SocketIO cần có thêm CORS của riêng SocketIO:them proxy cho socket
...
//   console.log("New client connectied");
...
// server.listen(port, () => {
//   console.log(`server is run on post ${port}`);
// });
