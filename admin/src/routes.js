...
import FormBookAdd from 'src/views/products/FormBookAdd';
import FormUserEdit from 'src/views/users/FormUserEdit';
import FormBookEdit from 'src/views/products/FormBookEdit';
...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'products/:ID_sach', element: <FormBookEdit /> },
      { path: 'products/them', element: <FormBookAdd /> },
